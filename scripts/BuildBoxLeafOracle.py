"""Build a QA-only public CM_BoxLeafnums observer against the existing native server build."""
...
out = root / '.tools/box-leaf-oracle'
...
compile_source('cm_load.c', out / 'cm-load-observed.o', define='CM_LoadMap=ObservedBoxLeafLoadMap')
compile_source('cm_test.c', out / 'cm-test-unfused.o')
compile_source('q_math.c', out / 'q-math-unfused.o')
compile_source('cm_load.c', out / 'observer.o', replacement=root / 'scripts/BoxLeafOracle.c')
