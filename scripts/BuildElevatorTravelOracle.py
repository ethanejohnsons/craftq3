"""Build the authored elevator travel host against an existing ignored official checkout."""
from pathlib import Path
import subprocess

source = Path(".tools/ioquake3-source")
base = source / "build/CMakeFiles/ioquake3.dir/code"
output = Path(".tools/elevator-travel-oracle")
...
subprocess.run(["clang", "-std=c11", "-O2", "-ffp-contract=off", "-Wl,-dead_strip",
                ...
                "-I/opt/homebrew/opt/libarchive/include", "scripts/ElevatorTravelOracle.c",
