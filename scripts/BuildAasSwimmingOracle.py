...
output=Path('.tools/swimming-oracle')
...
subprocess.run(['clang','-std=c11','-O2','-ffp-contract=off','-Wl,-dead_strip','-I'+str(source),'scripts/AasSwimmingOracle.c',*objects,'-o',str(output/'probe')],check=True)
